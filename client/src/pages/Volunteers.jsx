    ...
    <div className="grid gap-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <button type="button" className="btn-secondary" onClick={handleCsvDownload}>
            <Download size={16} />
            CSV
          </button>
          <button type="button" className="btn-secondary" onClick={handlePdfDownload}>
            <FileText size={16} />
            PDF
          </button>
        </div>
      ...
      <form className="page-card grid gap-3 p-4 md:grid-cols-[1fr_180px_210px_auto_auto]" onSubmit={handleSearch}>
        ...
        <button type="button" className="btn-secondary self-end" onClick={handleReset}>
          <RotateCcw size={16} />
          Reset
        </button>
      </form>
