...
export default function RecommendationBox() {
  ...
  return (
    <div className="page-card overflow-hidden">
      <div className="h-1 bg-brand-saffron" />
      <div className="p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="flex gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-lg font-semibold text-brand-navy dark:text-white">AI Volunteer Recommendation</h2>
      ...
      <div className="mt-4 flex flex-col gap-2 rounded-lg border border-teal-200 bg-teal-50 p-4 text-sm text-teal-900 dark:border-teal-900 dark:bg-teal-950 dark:text-teal-100 sm:flex-row sm:items-center sm:justify-between">
